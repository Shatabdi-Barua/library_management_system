...
<body>
<div class="book" id="div1">Books</div>
	
<div class="book house">House</div>

<div class="container"><br><br><br>
  <img class="in-middle logo" src="images/im1.jpg"> <br>
  <div class="row " >
 ...
 <div class="row">
  <div class="alert alert-warning col-sm-offset-3 col-sm-6" style="text-align: center;"> <strong>Login failed!!</strong></div></div>        
        <?php endif; ?>
</div>
...
<script type="text/javascript">
		$("document").ready(function(){
				...
				$(".house").hide().delay(1000).fadeIn(function(){
				 $(".house").delay(1000).fadeOut("fast");
				 $(".book").delay(1000).fadeOut("fast");
				});
